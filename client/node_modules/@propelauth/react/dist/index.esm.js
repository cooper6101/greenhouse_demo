...
function toOrgIdToUserOrgInfo(orgIdToOrgMemberInfo) {
  const orgIdToUserOrgInfo = {};
  for (const orgMemberInfo of Object.values(orgIdToOrgMemberInfo)) {
    orgIdToUserOrgInfo[orgMemberInfo.orgId] = new OrgMemberInfoClass(orgMemberInfo.orgId, orgMemberInfo.orgName, {}, orgMemberInfo.urlSafeOrgName, orgMemberInfo.userAssignedRole, orgMemberInfo.userInheritedRolesPlusCurrentRole, orgMemberInfo.userPermissions, orgMemberInfo.orgRoleStructure, orgMemberInfo.userAssignedAdditionalRoles, orgMemberInfo.legacyOrgId);
  }
  return orgIdToUserOrgInfo;
}
...
export { AuthProvider, AuthProviderForTesting, OrgMemberInfoClass, RedirectToLogin, RedirectToSignup, RequiredAuthProvider, UserClass, loadOrgSelectionFromLocalStorage, saveOrgSelectionToLocalStorage, useAccessHelper, useActiveOrg, useAuthInfo, useAuthUrl, useHostedPageUrls, useLogoutFunction, useOrgHelper, useRedirectFunctions, withAuthInfo, withRequiredAuthInfo };
